        ...
        {currentResult ? (
          <div className="relative w-full h-full">
            <iframe
              ...
              src={`https://www.youtube.com/embed/${currentResult.youtube_video_id}?autoplay=${isPlaying ? 1 : 0}&mute=${isMuted ? 0 : 1}&start=${Math.floor(currentResult.start_time_seconds)}&controls=0&showinfo=0&rel=0&modestbranding=0&loop=1&playlist=${currentResult.youtube_video_id}`}
              frameBorder="0"
